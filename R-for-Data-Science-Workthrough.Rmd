...
6. Setting the color aesthetic to `displ < 5` will assign one color to all x-axis (hwy) values < 5 and a different color to x-axis values ≤ 5. Since the color palette is not specified, default colors are used.  
```{r Exercises 3.3.1 6}
ggplot(data=mpg) +
